...
type AuthServiceClient interface {
	IsValidToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*IsValidTokenRequest, error)
}
...
func (c *authServiceClient) IsValidToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*IsValidTokenRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsValidTokenRequest)
...
type AuthServiceServer interface {
	IsValidToken(context.Context, *TokenRequest) (*IsValidTokenRequest, error)
...
func (UnimplementedAuthServiceServer) IsValidToken(context.Context, *TokenRequest) (*IsValidTokenRequest, error) {
...
func _AuthService_IsValidToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).IsValidToken(ctx, req.(*TokenRequest))
	}
